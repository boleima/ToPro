...
def evaluate(args, model, preprocessor, tokenizer, split='train', language='en', lang2id=None, prefix="", output_file=None):
    """Evalute the model."""
    ...
    for eval_task, eval_output_dir in zip(eval_task_names, eval_outputs_dirs):
        ...
        if output_file:
            ...
            with open(output_file, 'w', encoding='utf-8') as f_out:
                f_out.write('Prediction\tLabel\tLogits\n')
                for p, l, logits in zip(list(results['final_predictions']), list(out_label_ids), list(preds)):
                    f_out.write('{}\t{}\t{}\n'.format(p, l, logits))
