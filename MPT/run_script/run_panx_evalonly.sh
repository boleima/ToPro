export TASK_NAME=panx
export DATASET_NAME=panx
...
for lang in en af ar az bg bn de el es et eu fa fi fr gu he hi hu id it ja jv ka kk ko lt ml mr ms my nl pa pl pt qu ro ru sw ta te th tl tr uk ur vi yo zh; do
  echo
  echo -n "  $lang "
  echo
